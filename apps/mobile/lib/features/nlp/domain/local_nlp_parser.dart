...
const _vocabulary = <_VocabularyEntry>[
  ...
  _VocabularyEntry('difficulty concentrating', SymptomType.concentration),
  _VocabularyEntry('trouble concentrating', SymptomType.concentration),
  _VocabularyEntry('brain fog', SymptomType.concentration),
  ...
  _VocabularyEntry('lower back pain', SymptomType.cramps),
  ...
  _VocabularyEntry('exhausted', SymptomType.lowEnergy),
  _VocabularyEntry('tired', SymptomType.lowEnergy),
  _VocabularyEntry('insomnia', SymptomType.sleepDifficulty),
